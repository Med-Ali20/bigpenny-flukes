...
const FindFlukes: React.FC<any> = ({ data }) => {
  return (
    <section className='font-["Salford_Sans"] overflow-x-hidden' id="find-us">
      <Marquee
        autoFill
        className='uppercase mt-8 text-[25px] font-["Roc_Grotesk"] font-bold'
      >
      ...
      <div className="w-[325px] min-[1400px]:w-[84.33rem] outline-[3px] outline-[#D2451E] outline-offset-[-3px] mx-auto my-[40px] min-[1400px]:my-[60px] py-8 min-[1400px]:py-18 relative overflow-hidden">
        <span className="absolute bg-secondary border-[3px] border-[#D2451E] w-[18px] h-[18px] rounded-[50%] top-[-7px] left-[-7px]"></span>
        <span className="absolute bg-secondary border-[3px] border-[#D2451E] w-[18px] h-[18px] rounded-[50%] top-[-7px] right-[-7px]"></span>
        <span className="absolute bg-secondary border-[3px] border-[#D2451E] w-[18px] h-[18px] rounded-[50%] bottom-[-7px] right-[-7px]"></span>
        <span className="absolute bg-secondary border-[3px] border-[#D2451E] w-[18px] h-[18px] rounded-[50%] bottom-[-7px] left-[-5px]"></span>
        <h1 className="font-black uppercase mb-5 text-[50px] min-[1200px]:text-[90px] text-center leading-[51px] ">
        ...
        <div className="flex justify-center items-start gap-4 min-[1400px]:mt-15 min-[1400px]:items-center w-full">
          ...
          <div className="max-w-[450px] min-[1400px]:max-w-[550px] w-full gap-y-4 min-[1400px]:gap-x-6 px-6 grid grid-cols-2 items-start min-[1400px]:grid-cols-[1fr_2fr] ">
            <p className="font-black text-[25px] leading-[20px] min-[1400px]:text-[30px] font-['Salford_Sans'] min-[1400px]:leading-[35px] uppercase whitespace-nowrap">
              Our Address:
            </p>
            <address className="text-[25px] leading-[20px] min-[1400px]:text-[30px] font-['Salford_Sans'] min-[1400px]:leading-[35px]">
              {data.address}
            </address>
            ...
            <p className="text-[25px] leading-[20px] min-[1400px]:text-[30px] font-['Salford_Sans'] min-[1400px]:leading-[35px]">
              {data.tube}
            </p>
      ...
      <Marquee
        autoFill
        className='uppercase mt-14 min-[1400px]:mt-16 text-[25px] font-["Roc_Grotesk"] font-bold mb-18'
      >
        <span className="mr-2"></span> ● <span className="mr-2"></span> darts{" "}
        <span className="mr-2"></span> ● <span className="mr-2"></span> pool{" "}
        <span className="mr-2"></span> ● <span className="mr-2"></span> shuffle{" "}
