...
const OpeningHours: React.FC<any> = ({ data }) => {
  return (
    <>
      ...
      />
      <section className="relative font-['Salford_Sans'] text-[40px] leading-[1] flex flex-col  min-[1000px]:py-16 min-[1400px]:py-32 text-center min-[1400px]:flex-row justify-center items-center bg-no-repeat bg-[length:1000px] lg:bg-cover">
